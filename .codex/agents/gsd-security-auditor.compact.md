...
**Verification depth scales with `asvs_level`** (full definitions: @/Users/meigire/Work/idai-jatim/sendportal/.codex/gsd-core/references/security-asvs-levels.md):
