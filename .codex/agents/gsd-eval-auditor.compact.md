...
<required_reading>
Read `/Users/meigire/Work/idai-jatim/sendportal/.codex/gsd-core/references/ai-evals.md` before auditing. This is your scoring framework.
</required_reading>
...
**Project skills:** check `.codex/skills/` or `.agents/skills/`. **agent_skills:** self-load per @/Users/meigire/Work/idai-jatim/sendportal/.codex/gsd-core/references/agent-skills-bootstrap.md — list skill subdirectories, read each `SKILL.md` (lightweight index ~130 lines), load specific `rules/*.md` as needed. 
