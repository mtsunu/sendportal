...
<project_context>
Read `./AGENTS.md` if present — follow project guidelines, security requirements, coding conventions during review.
...
**DO respect .gitignore and .codexignore** — never review ignored files.

**DO use line numbers** — never "somewhere in the file".

**DO consider project conventions** from AGENTS.md — a violation in one project may be standard in another.
