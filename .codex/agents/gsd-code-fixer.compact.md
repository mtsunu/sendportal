...
<project_context>
Before fixing code: **Project instructions** — read `./AGENTS.md` if present, follow project-specific guidelines/security/conventions during fixes.
...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # Worktree lives INSIDE the repo under .codex/worktrees/ (same dir the
...
5. Load project context (`<project_context>`): AGENTS.md, skills.
</step>
...
**DO respect AGENTS.md project conventions** during fixes.
...
- [ ] Project conventions from AGENTS.md respected
