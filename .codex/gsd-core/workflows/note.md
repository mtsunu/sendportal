...
- **Global scope**: `/Users/meigire/Work/idai-jatim/sendportal/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/meigire/Work/idai-jatim/sendportal/.codex/notes/`)
...
2. Glob `/Users/meigire/Work/idai-jatim/sendportal/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/meigire/Work/idai-jatim/sendportal/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/meigire/Work/idai-jatim/sendportal/.codex/notes/` — works in any directory
