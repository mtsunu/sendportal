...
```
Agent(
  prompt="Read /Users/meigire/Work/idai-jatim/sendportal/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/meigire/Work/idai-jatim/sendportal/.codex/gsd-core/templates/SECURITY.md`
