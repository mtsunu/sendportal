...
The keys live in `.codex/settings.json` (project) or `/Users/meigire/Work/idai-jatim/sendportal/.codex/settings.json` (global) — **not** in `.planning/config.json`:
...
See @/Users/meigire/Work/idai-jatim/sendportal/.codex/gsd-core/references/planner-guidance.md for Granularity Calibration table (Coarse/Standard/Fine plans-per-phase).
