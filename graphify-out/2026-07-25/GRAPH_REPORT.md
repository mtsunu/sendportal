...
## Corpus Check
- 257 files · ~501,335 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1994 nodes · 2482 edges · 196 communities (161 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 59 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6de8a1cf`
...
1. `Communities (197 total, 37 thin omitted)` - 125 edges
2. `User` - 47 edges
...
## Communities (196 total, 35 thin omitted)

### Community 0 - "Workspace"
Cohesion: 0.11
Nodes (20): ApiToken, Workspace, currentWorkspace(), currentWorkspaceId(), getCurrentWorkspaceAttribute(), hasWorkspaces(), invitations(), onWorkspace() (+12 more)
...
Cohesion: 0.20
Nodes (5): LoginController, ProfileController, ProfileUpdateRequest, Illuminate\Contracts\View\View, Illuminate\Foundation\Auth\AuthenticatesUsers
...
Cohesion: 0.29
Nodes (5): PendingInvitationController, SwitchWorkspaceController, WorkspaceUsersController, Illuminate\Http\RedirectResponse, Illuminate\Http\Request
...
Cohesion: 0.11
Nodes (7): Workspace, WorkspacesController, ApiTokenStoreRequest, CreateWorkspaceRequest, WorkspaceStoreRequest, WorkspaceUpdateRequest, Illuminate\Foundation\Http\FormRequest
...
Cohesion: 0.02
Nodes (125): Communities (197 total, 37 thin omitted), Community 0 - "Workspace", Community 103 - "01-01-PLAN.md", Community 104 - "01-09-PLAN.md", Community 105 - "01-10-PLAN.md", Community 106 - "01-11-PLAN.md", Community 107 - "Standard Stack", Community 108 - "User Constraints (from CONTEXT.md)" (+117 more)
...
Cohesion: 0.20
Nodes (5): WorkspaceInvitationsController, Invitation, Workspace, SendInvitation, Carbon
...
Cohesion: 0.40
Nodes (4): Milestones, Phases, Progress, Roadmap: SendPortal PHP 8.4 Compatibility
...
Cohesion: 0.14
Nodes (8): WorkspacesRepository, AcceptInvitation, Workspace, AddWorkspaceMember, Workspace, CreateWorkspace, Illuminate\Contracts\Pagination\LengthAwarePaginator, Sendportal\Base\Repositories\BaseEloquentRepository
...
Cohesion: 0.10
Nodes (12): User, RemoveUserFromWorkspace, Admin, Illuminate\Foundation\Auth\User, Illuminate\Testing\TestResponse, NewUserInvitationTest, assertLoginRedirect(), createUserAndWorkspace() (+4 more)
...
Cohesion: 0.08
Nodes (13): CreatesApplication, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\WithFaker, AuthConfigDisabledTest, AuthConfigEnabledTest, WorkspaceApiTokenTest, SetupControllerTest, SwitchWorkspaceTest (+5 more)
...
### Community 195 - "HorizonServiceProvider"
Cohesion: 0.09
Nodes (6): HorizonServiceProvider, Illuminate\Contracts\Auth\MustVerifyEmail, Illuminate\Notifications\Notifiable, Laravel\Horizon\HorizonApplicationServiceProvider, ExistingUserInvitationTest, WorkspaceUserControllerTest
...
## Knowledge Gaps
- **998 isolated node(s):** `name`, `type`, `description`, `license`, `php` (+993 more)
...
- **Why does `User` connect `WorkspaceInvitationsControllerTest` to `Workspace`, `self`, `HorizonServiceProvider`, `InstallApplication`, `ApiTokenController`, `SetupTest`, `Illuminate\Http\RedirectResponse`, `Common Pitfalls`, `AcceptInvitation`, `Illuminate\Foundation\Testing\RefreshDatabase`, `RuntimeException`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
