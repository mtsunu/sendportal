...
INSTALL_JS_GLOBAL="/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
