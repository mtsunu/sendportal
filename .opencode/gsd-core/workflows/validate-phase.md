...
```
Agent(
  prompt="Read /Users/meigire/Work/idai-jatim/sendportal/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/templates/VALIDATION.md`
