...
`@/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
