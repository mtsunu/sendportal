...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/meigire/Work/idai-jatim/sendportal/.opencode/.gsd-surface.json`
(sibling to `/Users/meigire/Work/idai-jatim/sendportal/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/meigire/Work/idai-jatim/sendportal/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/meigire/Work/idai-jatim/sendportal/.opencode/skills`).
...
`/Users/meigire/Work/idai-jatim/sendportal/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/meigire/Work/idai-jatim/sendportal/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/meigire/Work/idai-jatim/sendportal/.opencode/.gsd-surface.json`
Install profile marker: `/Users/meigire/Work/idai-jatim/sendportal/.opencode/.gsd-profile`
Skill dirs: `/Users/meigire/Work/idai-jatim/sendportal/.opencode/skills/gsd-*/`
Engine module: `/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
