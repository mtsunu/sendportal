...
**Verification depth scales with `asvs_level`** (see @/Users/meigire/Work/idai-jatim/sendportal/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
