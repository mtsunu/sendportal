...
- next_action: Verify the targeted lock refresh locally, commit only the lock/debug evidence, push, and confirm CI reaches and passes both supported-driver jobs.
...
- verification: Pending remote CI confirmation for MySQL/PostgreSQL cross-process tests.
- files_changed: `composer.lock`
